"""
Módulo para entrenar modelo Random Forest de predicción de rendimiento estudiantil.
Modelo alternativo 2: Random Forest Optimizado.
"""
...
class RandomForestModel:
    """
    Clase para entrenar modelo Random Forest optimizado.
    """
    ...
    def train_model(self):
        """
        Entrena Random Forest con Random Search para optimización.
        """
        print("\n🌲 Entrenando Random Forest con Random Search...")
    ...
    def train_all(self):
        ...
        print("="*80)
        print("🚀 ENTRENAMIENTO RANDOM FOREST MODEL")
        print("="*80)
